...
<aside class="offcanvas" id="my_offcanvas1">
    ...
    <nav class="list-group list-group-flush">
        ...
        <a href="news/" class="list-group-item border-0 text-dark text-decoration-none hvr-grow">News</a>
        <?php if(!empty($_SESSION['id'])){
            if($result['status'] == "0"){ ?>
                <a href="news/upload.php" class="list-group-item border-0 text-dark text-decoration-none hvr-grow">Upload News</a>
            <?php }else{}
        }else{}?>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item">
                    <a class="nav-link text-dark mr-2 hvr-grow" href="index.php">Home</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-dark mr-2 hvr-grow" href="aboutus.php">About</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-dark mr-2 hvr-grow" href="news/">News</a>
                </li>
                <?php if(!empty($_SESSION['id'])){
                    if($result['status'] == "0"){ ?>
                        <li class="nav-item">
                            <a href="news/upload.php" class="nav-link text-dark mr-2 hvr-grow">Upload News</a>
                        </li>
                    <?php }else{}
                }else{}?>
                <li class="nav-item">
                    <a class="nav-link text-dark mr-2 hvr-grow" href="contactus.php">Contact Us</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-dark mr-2 hvr-grow" href="faq.php">FAQ</a>
                </li>
            </ul>
            <ul class="navbar-nav ml-auto">
                ...
                {?>
                <li class="nav-item">
                    <a class="text-dark font-weight-bold" href="account.php?id=<?php echo $result['id'];?>"> <?php echo $result['username'];?></a>
                </li>
                <li class="nav-item">
                    <a class="btn btn-outline-dark py-1 mt-3 rounded-pill" href="logout.php"><i class="fa fa-sign-out" aria-hidden="true"></i> Logout</a>
                </li>
                <?php } else{?>
                <li class="nav-item">
                    <button class="nav-link btn text-dark mr-2 hvr-grow" href="#" data-toggle="modal" data-target="#login"><i class="fas fa-sign-in-alt align-middle"></i> Login</button>
                </li>
                <li class="nav-item">
                        ...
                        <div class="col-12">
                            <div class="tab">
                                <div class="input-group mb-4">
                                    ...
                                    <input id="signupbtn" type="text" class="form-control border-top-0 border-left-0 border-right-0 rounded-0" name="username" placeholder="Username" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default"  required>
                                </div>
                                <div class="input-group mb-4">
                                    <div class="input-group-prepend">
                                    ...
                                    <input id="signupbtn" type="text" class="form-control border-top-0 border-left-0 border-right-0 rounded-0" name="email" placeholder="Email" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default"  required>
                                </div>
                                <div class="input-group mb-4">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text bg-white border-top-0 border-left-0 border-right-0 rounded-0" id="inputGroup-sizing-sm"><i class="fa fa-key" aria-hidden="true" ></i></span>
                                    </div>
                                    <input id="signupbtn" type="password" class="form-control border-top-0 border-left-0 border-right-0 rounded-0" name="password" placeholder="Password" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" required>
                                </div>
                            ...
                            <div class="tab">
                                <div class="input-group mb-4">
                                    ...
                                    <input id="signupbtn" type="text" class="form-control border-top-0 border-left-0 border-right-0 rounded-0" name="fullname" placeholder="Fullname" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default"  required>
                                </div>
                                <div class="input-group mb-4">
                                    <div class="input-group-prepend">
                                    ...
                                    <input id="signupbtn" type="text" class="form-control border-top-0 border-left-0 border-right-0 rounded-0" name="dob" placeholder="Date of Birth (DD/MM/YY)" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default"  required>
                                </div>
                                <div class="input-group mb-4">
                                    <div class="input-group-prepend">
                                    ...
                                    <input id="signupbtn" type="text" class="form-control border-top-0 border-left-0 border-right-0 rounded-0" name="postalcode" placeholder="Postal code" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" required>
                                </div>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                    ...
                                    <input id="signupbtn" type="text" class="form-control border-top-0 border-left-0 border-right-0 rounded-0" name="address" placeholder="Address" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" required>
                                </div>
                            </div>
                        </div>
                    </div>
